...
def main():
    ...
    # Limiting to 3 epochs for demonstration speed
    ...
    plt.tight_layout()
    viz_path = os.path.join('visualizations', 'cnn_training_history.png')
    ...
    pred_path = os.path.join('visualizations', 'cnn_predictions.png')
